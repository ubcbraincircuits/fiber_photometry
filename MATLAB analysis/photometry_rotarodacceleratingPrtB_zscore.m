...
tssub_start = tssub - data.epocs.PrtB.onset(1,1);
note_start = data.epocs.Note.onset - data.epocs.PrtB.onset(1,1);
rotarod_stop = data.epocs.PrtB.onset(2,1) - data.epocs.PrtB.onset(1,1);
