...
ctr=data.streams.x05B.data(round(10*Fs):end);
sig=double(sig);
ctr=double(ctr);
...
for i=1:length(data.epocs.Note.onset)
    note(i)=data.epocs.Note.onset(i,1);
    line ([note(i) note(i)],[-20 20],'color','g')
    text(note(i),i*1,1,data.epocs.Note.notes(i,1)) 
end
%vline([data.epocs.Note.onset(1,1) data.epocs.Note.onset(2,1) data.epocs.Note.onset(3,1) data.epocs.Note.onset(4,1)], {'k', 'g', 'g', 'k'});
...
Start = round(Notepoints(2,1));
Stop = round(Notepoints(3,1));
Down = round(Notepoints(4,1));
...
title(data.info.blockname(1,:),'Interpreter','none')
vline([data.epocs.Note.onset(1,1) data.epocs.Note.onset(4,1) data.epocs.Note.onset(2,1) data.epocs.Note.onset(3,1)], {'k', 'k', 'g', 'g'});
...
note_start = data.epocs.Note.onset - data.epocs.Note.onset(2,1);
tssub_start = tssub - data.epocs.Note.onset(2,1); 
...
ylabel('Z Score','FontSize',14)
title(data.info.blockname(1,:),'Interpreter','none')
vline([note_start(1,1) note_start(4,1) 0 note_start(3,1) ], {'k', 'k', 'g', 'g'});
daspect([1 0.05 1])
hold off
...
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\New Start Align\', data.info.blockname(1,:)],'startalign', '-ascii');
...
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\New Z Scores\', data.info.blockname(1,:)],'Meansnew', '-ascii');
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\New Norm Z Scores\', data.info.blockname(1,:)],'Meanshift', '-ascii');
...
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\New 30s Means\', data.info.blockname(1,:)],'thirty', '-ascii');
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\New 60s Means\', data.info.blockname(1,:)],'sixty', '-ascii');
...
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\New SDs\', data.info.blockname(1,:)],'Stdevs', '-ascii');

Stdevchange = Stdevs/stdbefore;
stdrotchange = stdrotarod/stdbefore;
figure; plot(Stdevchange);

save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\New SD change\', data.info.blockname(1,:)],'Stdevchange', '-ascii');
...
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\30s SDs\', data.info.blockname(1,:)],'thirtySD', '-ascii');
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\60s SDs\', data.info.blockname(1,:)],'sixtySD', '-ascii');
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\30s SDs change\', data.info.blockname(1,:)],'thirtySDchange', '-ascii');
save(['Z:\Raymond Lab\Ellen\Fiber Photometry\6-7 month GCAMP YAC128\6-7 month rotarod analysis\60s SDs change\', data.info.blockname(1,:)],'sixtySDchange', '-ascii');
